  ...
  [13],
  {
    617: function (t, e, n) {
      ...
      function m(t, e, n) {
        ...
        return function () {
          0 <= e.value &&
            (n || y.has(e) || "hidden" === document.visibilityState) &&
            ((e.delta = e.value - (i || 0)),
      ...
      function u(t, e) {
        l || ((l = e), (h = t), (i = new Date()), v(removeEventListener), d());
      }
      function d() {
        var e;
        0 <= h &&
      ...
      var l,
        ...
        y = new ("function" == typeof WeakSet ? WeakSet : Set)(),
        a = function (t, e) {
          function n(t) {
          ...
          function t(t) {
            "first-contentful-paint" === t.name &&
              ...
              t.startTime < a.timeStamp &&
                ((r.value = t.startTime), r.entries.push(t), y.add(r), i()));
          }
          var i,
            a = p(),
            r = c("FCP"),
            ...
            S(function (t) {
              (r = c("FCP")),
                ...
                requestAnimationFrame(function () {
                  requestAnimationFrame(function () {
                    (r.value = performance.now() - t.timeStamp), y.add(r), i();
                  });
                });
            }));
        },
              ...
              ? ((n = e),
                ...
                (a = function () {
                  removeEventListener("pointerup", r, w),
                    removeEventListener("pointercancel", o, w);
                }),
        ...
        F = function (t, e) {
          function n(t) {
            t.startTime < i.timeStamp &&
              ((a.value = t.processingStart - t.startTime),
              a.entries.push(t),
              y.add(a),
              o());
          }
          ...
          r &&
            f(function () {
              r.takeRecords().map(n), r.disconnect();
            }, !0),
            r &&
              S(function () {
                (a = c("FID")),
        ...
        k = function (e, n) {
          function t(t) {
            var e = t.startTime;
            e < r.timeStamp && ((o.value = e), o.entries.push(t)), i();
          }
          var i,
            a,
            r = p(),
            o = c("LCP"),
            u = s("largest-contentful-paint", t);
          u &&
            ((i = m(e, o, n)),
            (a = function () {
              y.has(o) ||
                (u.takeRecords().map(t), u.disconnect(), y.add(o), i());
            }),
            ...
            S(function (t) {
              (o = c("LCP")),
                ...
                requestAnimationFrame(function () {
                  requestAnimationFrame(function () {
                    (o.value = performance.now() - t.timeStamp), y.add(o), i();
                  });
                });
            }));
        },
